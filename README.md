...
![Version](https://img.shields.io/badge/version-1.2.0-e85b68)
...
当前版本为 `v1.2.0` 正式版，重点完成了完整赛事路线、任务中心、荣誉殿堂、新手引导、响应式布局和本地存档。
...
- 新增独立任务中心入口，统一查看当前任务与赛季任务。
- 新增每周任务进度、奖励领取和完成历史。
- 新增赛季长期目标：完整首发、赛场常客、晋级之路、荣誉留名。
- 任务奖励支持资金与声望发放，并写入本地存档。
- 增加任务中心响应式布局，适配桌面、平板和手机。
- 更新启动页、版本徽章和管理中心发布信息至 。
